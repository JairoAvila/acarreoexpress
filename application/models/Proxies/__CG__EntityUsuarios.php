 ...
 */
class Usuarios extends \Entity\Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Usuarios' . "\0" . 'id', '' . "\0" . 'Entity\\Usuarios' . "\0" . 'email', '' . "\0" . 'Entity\\Usuarios' . "\0" . 'password', '' . "\0" . 'Entity\\Usuarios' . "\0" . 'token', '' . "\0" . 'Entity\\Usuarios' . "\0" . 'device', '' . "\0" . 'Entity\\Usuarios' . "\0" . 'idestado');
        }
