 ...
 */
class Subcategoria extends \Entity\Subcategoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Subcategoria' . "\0" . 'id', '' . "\0" . 'Entity\\Subcategoria' . "\0" . 'nombre', '' . "\0" . 'Entity\\Subcategoria' . "\0" . 'precio', '' . "\0" . 'Entity\\Subcategoria' . "\0" . 'idcategoria', '' . "\0" . 'Entity\\Subcategoria' . "\0" . 'idestado');
        }
     ...
     * {@inheritDoc}
     */
    public function setIdcategoria(\Entity\Categorias $idcategoria = NULL)
    {
