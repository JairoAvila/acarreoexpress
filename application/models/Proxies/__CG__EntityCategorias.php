 ...
 */
class Categorias extends \Entity\Categorias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Categorias' . "\0" . 'id', '' . "\0" . 'Entity\\Categorias' . "\0" . 'nombre', '' . "\0" . 'Entity\\Categorias' . "\0" . 'precio', '' . "\0" . 'Entity\\Categorias' . "\0" . 'idestado');
        }
