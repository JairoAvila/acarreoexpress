 ...
 */
class Ciudades extends \Entity\Ciudades implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Ciudades' . "\0" . 'id', '' . "\0" . 'Entity\\Ciudades' . "\0" . 'ciudad');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ciudades $proxy) {
