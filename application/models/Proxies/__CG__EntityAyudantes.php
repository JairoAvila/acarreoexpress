 ...
 */
class Ayudantes extends \Entity\Ayudantes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Ayudantes' . "\0" . 'id', '' . "\0" . 'Entity\\Ayudantes' . "\0" . 'numero', '' . "\0" . 'Entity\\Ayudantes' . "\0" . 'precio');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Ayudantes $proxy) {
